...
const navConfig = [
  ...
  // ----------------------------------------------------------------------
  {
    ...
    items: [
      ...
      //   children: [
      //     { title: 'posts', path: PATH_DASHBOARD.salesOrder.posts },
      //     { title: 'post', path: PATH_DASHBOARD.salesOrder.postById },
      //     { title: 'new post', path: PATH_DASHBOARD.salesOrder.newPost },
      //   ],
      // },
    ],
  },
