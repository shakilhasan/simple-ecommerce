# Welcome to the simple-ecommerce Project
...
Below are the sample of a product-shop page:

![Product List Page](docs/images/Shop.png)

Multiple-Variant product detail page:
![Product List Page](docs/images/MultipleVariant.png)

No-Variant product detail page:
![Product List Page](docs/images/NoVariant.png)
...
1. Download the provided <br/>
  - <a href="https://raw.githubusercontent.com/shakilhasan/simple-ecommerce/main/docs/postman/ecommerce.postman_collection.json" target="_blank">Ecommerce Collection</a> file (`Right-Click -> Save As`).
    <br/> <br/>
2. Open Postman and click `Import` and choose the `ecommerce` Collection file that was downloaded from the link above. <br/> <br/>
   <img src="docs/images/importCollection.png">